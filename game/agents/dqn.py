...
# # from ..ox5 import TicTacToeGame, TicTacToeAction, GamePlayer, BOARD_SIZE, BOARD_DIM
# BOARD_SIZE = 20
# BOARD_DIM = 2
#
# def lerp(v, d):
...
#
#     self.num_games = -1
#     self.n_inputs = BOARD_SIZE * BOARD_SIZE
...
#
#   def get_model_inputs(self, game):
